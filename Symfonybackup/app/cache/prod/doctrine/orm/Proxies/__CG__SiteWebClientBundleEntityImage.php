 ...
 */
class Image extends \SiteWeb\ClientBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'SiteWeb\\ClientBundle\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'SiteWeb\\ClientBundle\\Entity\\Image' . "\0" . 'url', '' . "\0" . 'SiteWeb\\ClientBundle\\Entity\\Image' . "\0" . 'width', '' . "\0" . 'SiteWeb\\ClientBundle\\Entity\\Image' . "\0" . 'height');
        }
