...
namespace Proxies\__CG__\SiteWeb\ClientBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Advert extends \SiteWeb\ClientBundle\Entity\Advert implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'SiteWeb\\ClientBundle\\Entity\\Advert' . "\0" . 'id', '' . "\0" . 'SiteWeb\\ClientBundle\\Entity\\Advert' . "\0" . 'date', '' . "\0" . 'SiteWeb\\ClientBundle\\Entity\\Advert' . "\0" . 'title', '' . "\0" . 'SiteWeb\\ClientBundle\\Entity\\Advert' . "\0" . 'author', '' . "\0" . 'SiteWeb\\ClientBundle\\Entity\\Advert' . "\0" . 'content', '' . "\0" . 'SiteWeb\\ClientBundle\\Entity\\Advert' . "\0" . 'published', '' . "\0" . 'SiteWeb\\ClientBundle\\Entity\\Advert' . "\0" . 'image');
        }
     ...
     * {@inheritDoc}
     */
    public function setImage(\SiteWeb\ClientBundle\Entity\Image $image = NULL)
    {
