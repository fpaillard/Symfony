...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'siteweb_client.antispam' => 'getSitewebClient_AntispamService',
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'C:\\wamp\\www\\Symfony\\src\\SiteWeb\\ClientBundle\\Entity')), 'SiteWeb\\ClientBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('SiteWebClientBundle' => 'SiteWeb\\ClientBundle\\Entity'));
    ...
    /**
     * Gets the 'siteweb_client.antispam' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \SiteWeb\ClientBundle\Antispam\SiteWebAntispam A SiteWeb\ClientBundle\Antispam\SiteWebAntispam instance.
     */
    protected function getSitewebClient_AntispamService()
    {
        return $this->services['siteweb_client.antispam'] = new \SiteWeb\ClientBundle\Antispam\SiteWebAntispam($this->get('swiftmailer.mailer.default'), 'fr', 50);
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('boselli.mathieu');
        $a->setPassword('fcbarcelone');
        $a->setAuthMode('login');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\wamp\\www\\Symfony\\src\\SiteWeb\\ClientBundle/Resources/views', 'SiteWebClient');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SiteWebClientBundle' => 'SiteWeb\\ClientBundle\\SiteWebClientBundle',
            ...
            'mailer_host' => NULL,
            'mailer_user' => 'boselli.mathieu',
            'mailer_password' => 'fcbarcelone',
            'locale' => 'fr',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'boselli.mathieu',
            'swiftmailer.mailer.default.transport.smtp.password' => 'fcbarcelone',
