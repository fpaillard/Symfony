...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/a')) {
            // Siteweb_Client_view
            if (0 === strpos($pathinfo, '/annonce') && preg_match('#^/annonce/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
        ...
        if (rtrim($pathinfo, '/') === '/mesAnnonces') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'Siteweb_Client_myAdverts');
            }

            return array (  '_controller' => 'SiteWeb\\ClientBundle\\Controller\\AdvertController::myAdvertsAction',  '_route' => 'Siteweb_Client_myAdverts',);
        }
